...
- `decimal.mark` is set as "," 
- `big.mark` is left as `NULL`, which lets `scales::number()` pick them up from the locale if set, or fall back to its own defaults.. 
